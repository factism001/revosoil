...
class SoilPropertiesForm(forms.Form):
    ...
    available_phosphorus_mg/kg = forms.CharField(label='Available Phosphorus (mg/kg)', required=False)
    exch_acidity_/kg = forms.CharField(label='Exch Acidity (/kg)', required=False)
    ca_cmol/kg = forms.CharField(label='Ca (cmol/kg)', required=False)
    mg_cmol/kg = forms.CharField(label='Mg (cmol/kg)', required=F)
    k_cmol/kg = forms.CharField(label='K (cmol/kg)', required=False)
    na_cmol/kg = forms.CharField(label='Na(cmol/kg)', required=False)
    mn_mg/kg = forms.CharField(label='Mn (mg/kg)', required=False)
    fe_mg/kg = forms.CharField(label='Fe (mg/kg)', required=False)
    cu_mg/kg = forms.CharField(label='Cu(mg/kg)', required=False)
    zn_mg/kg = forms.CharField(label='Zn (mg/kg)', required=False)
